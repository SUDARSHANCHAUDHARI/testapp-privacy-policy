...
This repository contains the public privacy policy for TestApp.

- Privacy policy: [PRIVACY_POLICY.md](PRIVACY_POLICY.md)
- Web version: https://sudarshanchaudhari.github.io/testapp-privacy-policy/
...
TestApp ("we," "our," or "us") is a test app. TestApp is a test application used for development and validation workflows. This Privacy Policy explains what information the app collects, how it is used, and the choices you have. By installing or using TestApp you agree to the practices described below.

## Information We Collect

### Location Data
- TestApp does not collect location data unless a specific test build explicitly requests it for a test case.

### Account Information
- No account is required to use TestApp.

### Device Information
- Test data, preferences, logs, or configuration used by the installed test build may be stored locally.

## How We Use Your Information

### Location Sharing
- Location is not used unless a specific test build makes that clear for a test case.

### Account Management
- Run development and validation scenarios locally.

### Service Improvement
- Support testing and debugging workflows.
- We do not sell, rent, or monetize test data.

## Storage and Retention

### Data Storage
- Test data and preferences are stored locally unless a specific test build documents otherwise.

### Data Retention
- Local test data remains until you clear it, uninstall the app, or reset the test environment.
...
### Family Groups
- TestApp does not use MyFamilyTracker-style family groups unless explicitly described in this policy.
...
### Third Parties
- No test data is shared with third parties by Sudarshan Tech Labs unless a specific test build explicitly integrates a third-party service.
...
* **Only the permissions required by the specific installed test build are used.**

### Optional Permissions

* You can revoke permissions or uninstall the app after testing.

## Your Rights and Controls

### Location Sharing Control
- No standard location sharing exists in TestApp.

### Account Management
- No account is required.

### Data Access
- You can clear local test data through Android settings or the test build controls.
...
### Permissions
- You can revoke Android permissions in Android Settings -> Apps -> TestApp -> Permissions.
...
* **GitHub Repository:** https://github.com/SUDARSHANCHAUDHARI/testapp-privacy-policy
* **Email:** sunny.sudarshan@gmail.com
* **Main App Repository:** https://github.com/SUDARSHANCHAUDHARI/TestApp
...
- Subject: "Data Deletion Request - TestApp"
...
- No third-party cloud service is required for the default test policy.
...
TestApp is built with privacy in mind. The app is built with:
- Development/test workflows
- Local test data and preferences
- Permission behavior depends on the installed test build
...
- **Clarified that TestApp is a development/test app and data handling depends on the installed build.**
